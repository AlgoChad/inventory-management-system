...
import { shuffleArray } from "~/core/utils/helpers/GeneralHelpers";

export const loader: LoaderFunction = async () => {
    const imagePaths = Array.from({ length: 19 }, (_, i) => `/ism-desktop-app/app/assets/home/${i + 1}.jpg`);

    console.log("imagePaths", liveWiseLogo);
